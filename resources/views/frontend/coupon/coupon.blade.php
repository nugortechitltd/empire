                ...
                <form method="POST" action="{{route('coupon.store')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="form-group">
                            ...
                            <input type="text" name="coupon_name" class="form-control" placeholder="name">
                            @error('coupon_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="coupon_amount" class="form-control" placeholder="amount">
                            @error('coupon_amount')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                            <div class="clearfix"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="b-m-dtp-date" name="coupon_validity" class="form-control" placeholder="Date" data-dtp="dtp_S2pSu">
