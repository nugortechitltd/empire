...
<div class="container-fluid flex-grow-1 container-p-y pt-5">
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('setting.info.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            {{-- <div class="col-lg-12"> --}}
                                ...
                                <textarea name="setting_info" class="form-control" placeholder="Info"></textarea>
                                @error('setting_info')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                                <div class="clearfix"></div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group upload_file">
                                    ...
                                    @error('favicon')
                                        <strong class="text-danger">{{$message}}</strong>
                                    @enderror
                                    <img width="90" class="mt-3 mb-3" id="favicon" height="auto" src="" alt="">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group upload_file">
                                    ...
                                    @error('app_image')
                                        <strong class="text-danger">{{$message}}</strong>
                                    @enderror
                                    <img width="90" class="mt-3 mb-3" id="app_image" height="auto" src="" alt="">
                                </div>
                            </div>
                        </div>
                        <div>
