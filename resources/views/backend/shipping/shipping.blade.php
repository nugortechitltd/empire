            ...
            <div class="card-body">
                <form method="POST" action="{{route('shipping.info.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            <label class="form-label w-100 mb-2">Shipping</label>
                            ...
                            <tbody>
                                @foreach ($shipping_info as $info)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('shipping.edit', $info->id)}}" class="btn btn-info btn-sm"><i class="feather icon-edit"></i>&nbsp;Edit </a>
                                            <a href="{{route('shipping.delete', $info->id)}}" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
