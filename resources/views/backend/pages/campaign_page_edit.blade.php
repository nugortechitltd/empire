...
<div class="container-fluid flex-grow-1 container-p-y pt-5">
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{route('campaign.info.update')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label class="form-label">Button</label>
                        <input type="text" name="button" class="form-control" placeholder="name" value="{{$info->button}}">
                        <input type="hidden" name="campaign_id" class="form-control" placeholder="Subtitle" value="{{$info->id}}">
                        @error('button')
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <img style="width: 200px; height: 100px" class="mt-3 mb-3" id="image1" height="auto" src="{{asset('uploads/pages/campaign')}}/{{$info->image}}" alt="">
                    </div>
                        <div>
