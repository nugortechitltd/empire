...
<div class="container-fluid flex-grow-1 container-p-y pt-5">
    <div class="row">
        ...
        <div class="card mb-4">
            <h6 class="card-header">index Info</h6>
            <div class="card-body">
                {{--  --}}
                <form method="POST" action="{{route('index.info.store')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <table id="report-table" class="table mb-0">
                            ...
                            <tbody>
                                @foreach ($indexinfo as $info)
                                    <tr>
                                        <td><img src="{{asset('uploads/pages/index')}}/{{$info->image}}" alt class="img-fluid" style="width: 150px"></td>
                                        <td>{{$info->button}}</td>
                                        <td>{{$info->url}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('index.info.edit', $info->id)}}" class="btn btn-primary btn-sm"><i class="feather icon-eye"></i>&nbsp;Edit </a>
                                            <a href="{{route('index.info.delete', $info->id)}}" class="btn btn-danger btn-sm"><i class="feather icon-trash-2"></i>&nbsp;Delete </a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
